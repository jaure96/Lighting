#ifndef visualSTATE_LIGHTING_H
#define visualSTATE_LIGHTING_H
...
typedef enum {EVENT_TYPE = 0U, STATE_TYPE = 1U} IdentifierType;
...
#else
#error VS_UINT32 unsupported data type
#error VS_INT32 unsupported data type
#endif
...
#endif /* ifndef visualSTATE_LIGHTING_H */
